// Programmiersprachen 3.1 (Aufgabenblatt 3)
...
int main () {
 ...
 for (std::vector<int>::iterator it = v0.begin(); it != v0.end(); ++it) { // iteriert ueber den Vektor von Beginn (0) bis Ende (9) und erhoeht i um 1
